		...
		<div class="page-main">
			...
			<div class="my-3 my-md-5">
				<div class="container">
					<div class="row">              
						<div class="col-lg-12">
							<form class="card" id="form-adicionar">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" name="Descricao" class="form-control" name="example-text-input" placeholder="Arroz..">
											</div>
										</div>
										...
										<div class="col-sm-6 col-md-4">
											<div class="form-group">
												...
												<input type="number" name="CodBarra" class="form-control" placeholder="78978978978978">
											</div>
										</div>
										<div class="col-sm-6 col-md-4">
											<div class="form-group">
												...
												<div class="input-group">
													...
													<input type="number" min="0.00" max="10000.00" step="0.01" name="Valor" class="form-control text-right" aria-label="Valor">
												</div>
											</div>
										</div>                    
									</div>
								...
								<div class="card-footer text-left" style="display: flex; justify-content: space-between">
									...
									<div>
										<button type="submit" class="btn btn-primary btn-add-produto">Confirmar</button>
									</div>                                    
								</div>                
							</form>
							<script>
